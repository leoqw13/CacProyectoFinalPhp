...
<html lang="es">
  ...
  <title>PHP - Modificar Pedido</title>
    <!-- Style CSS -->
...
?>
        <div class="container">
          ...
          <form
            ...
            novalidate
            action="../controller/updatePedido.php"
            method="POST"
          >
            ...
            <div class="row">
              <div class="col-md-6 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getNombre(); ?>"
                  required
                />
              ...
              <div class="col-md-6 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getApellido(); ?>"
                  required
                />
              ...
              <div class="col-md-12 mb-3 text-center">
                ...
                <div class="input-group">
                  ...
                  <input
                    ...
                    name="username"
                    placeholder="Usuario"
                    value="<?php echo $pedido->getUsuario(); ?>"
                    required
                  />
            ...
            <div class="row">
              <div class="col-md-12 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getLugarEntrega(); ?>"
                  required
                />
 ...
 <div class="col-md-4 mb-3">
  ...
  <div class="col-md-3 mb-3">
    ...
    <input
      ...
      value="<?php echo $pedido->getCodPostal(); ?>"
      required
    />
            ...
            <div class="row">
              <div class="col-md-6 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getTarjtitular(); ?>"
                  required
                />
              ...
              <div class="col-md-6 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getTarjnumero(); ?>"
                  required
                />
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3 text-center">
                ...
                type="date"
                  ...
                  value="<?php echo $pedido->getTarjvto(); ?>"
                  required
                />
                <div class="invalid-feedback">
              ...
              <div class="col-md-3 mb-3 text-center">
                ...
                <input
                  ...
                  value="<?php echo $pedido->getTarjclave(); ?>"
                  required
                />
